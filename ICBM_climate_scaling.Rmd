...
$$
\frac{dY_{(t)}}{dt}=I_{(t)} - k_y \cdot \color{red}{r} \cdot Y \\
\frac{dY_{(t)}}{dt}= h \cdot k_y \cdot \color{red}{r}  \cdot Y  - k_o \cdot \color{red}{r}  \cdot O
$$
